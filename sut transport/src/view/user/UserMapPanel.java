...
public class UserMapPanel extends JPanel {
    ...
    private final Color COLOR_ORANGE_BTN = new Color(255, 160, 100);
    private final Color COLOR_RED_CLOSE = new Color(255, 100, 100);

    public UserMapPanel(UserMainFrame parentFrame) {
        this.parentFrame = parentFrame;

        setLayout(null);
        setBackground(new Color(255, 244, 225)); 
        
        // โหลดข้อมูลรูปภาพ (เรียกฟังก์ชันที่จัดระเบียบแล้ว)
        initGalleryData();

        JLabel lblTitle = new JLabel("แผนที่การเดินทาง");
        ...
        lblTitle.setBounds(50, 15, 600, 50); 
        add(lblTitle);
        ...
        mapPanel.setBounds(40, 70, 830, 440); 
        add(mapPanel);
    ...
    private void createStationPin(JPanel panel, int index, Font font) {
        int targetX = LOCATIONS[index].x;
        int targetY = LOCATIONS[index].y;
        ...
        btnPin.setBounds(targetX - 30, targetY - 60, 60, 70);
        ...
        // ขยับตัวหนังสือ บขส.
        int labelX = targetX - 70; 
        int labelY = targetY + 10; 

        if (name.equals("บขส. ใหม่")) {
            labelX = labelX + 50; 
            labelY = labelY - 5; 
        }
        
        lblName.setBounds(labelX, labelY, 140, 25); 
        panel.add(lblName);
    }
    ...
    private void showGalleryPopup(String stationName) {
        ...
        lblHeader.setForeground(new Color(120, 70, 0)); 
    ...
    private void styleRoundedButton(JButton btn, Color bgColor) {
        ...
        btn.setUI(new javax.swing.plaf.basic.BasicButtonUI() {
            ...
            public void paint(Graphics g, JComponent c) {
                ...
                if (b.getModel().isPressed() && b.isEnabled()) color = color.darker();
